<template>
    <div id="login">
        <div id="contain">
            <div id="left_card">
                <h1>ChatGPT </h1>
                <span>ChatGPT Chat platform</span>
            </div>
            <div id="right_card">
    ...
    export default {
        ...
        setup(){
            ...
            async function usreList(){
                ...
                if(userLoginForm.username.includes('admin')){
                    // console.log("登录1",userLoginForm.username)
                    // localStorage.setItem("login",userLoginForm.username)
    ...
    #login{
        ...
        width: 100vw;
        height: 100vh;
        background-image: url(./../assets/waterbackground.jpg);
